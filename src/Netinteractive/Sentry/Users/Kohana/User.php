<?php namespace Netinteractive\Sentry\Users\Kohana;
/**
...
use Netinteractive\Sentry\Users\UserAlreadyActivatedException;
use Netinteractive\Sentry\Users\UserExistsException;
...
class User extends \ORM implements UserInterface {
	 ...
	 *
	 * @param \Netinteractive\Sentry\Hashing\HasherInterface  $hasher
	 * @return void
	 */
	 ...
	 *
	 * @return \Netinteractive\Sentry\Hashing\HasherInterface
	 */
